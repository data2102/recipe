...
> 2026-09-15 식단을 날짜로: 홈은 이번 주·다음 주 열나흘을 세로로 늘어놓는
> 식단 화면이고, 날짜마다 "저녁 약속" 같은 메모를 적을 수 있습니다.
> 담기는 날짜를 물어 그 날짜로 바로 넣습니다. 장보기에서 체크한 항목은
> 맨 아래로 내려갑니다.
>
> 2026-09-10 UI/UX 개선: 담기는 즉시 처리, 장보기는 합친 목록이 기본입니다.
> 보유 재료 제외는 해당 주 목록에 저장합니다.
>
> 현재 사용법은 [쓰는 법](docs/how-to-use.md), 배포 전 필요한 마이그레이션은
...
| [`docs/changes-20260916.md`](docs/changes-20260916.md) | **바뀐 것 AS-IS / TO-BE.** 폰 앱 · API 층 · 화면 손질 · 어두운 모드, 그리고 **안 한 것과 왜** |

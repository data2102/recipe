...
> 2026-09-10 UI/UX 개선: 홈은 오늘 메뉴 우선, 담기는 즉시 처리, 장보기는
> 합친 목록이 기본입니다. 보유 재료 제외는 해당 주 목록에 저장합니다.
> 현재 사용법은 [쓰는 법](docs/how-to-use.md), 배포 전 필요한 추가 컬럼은
> [배포 가이드](docs/deploy.md#2026-09-10-ux-변경-배포)를 확인하세요.
